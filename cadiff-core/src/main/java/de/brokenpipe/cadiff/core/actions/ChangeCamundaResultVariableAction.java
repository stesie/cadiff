...
public record ChangeCamundaResultVariableAction(String id, String oldValue, String newValue) implements ChangePropertyAction<String> {
	...
	public Patcher patcher() {
		return new GenericChangePropertyPatcher<>(this, BusinessRuleTask.class, BusinessRuleTask::getCamundaResultVariable, BusinessRuleTask::setCamundaResultVariable);
	}
}
